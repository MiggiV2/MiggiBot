...
public class SlashCommandRegisterAction
{
	...
	{
		List<SlashCommandBuilder> commands = Arrays.asList(
			...
			new SlashCommandBuilder()
				...
				.setDescription("Config a reaction role!")
				.addOption(
					new SlashCommandOptionBuilder()
						.setName("Role")
						.setDescription("Which role should be automatically added, on reaction?")
				...
				.addOption(
					new SlashCommandOptionBuilder()
						.setName("MessageLINK")
						.setDescription("Which message is yours?")
						.setType(SlashCommandOptionType.STRING)
						.setRequired(true)
						.build()),
			new SlashCommandBuilder()
				.setName("welcomer")
				.setDescription("Config your server welcomer channel!")
				.addOption(
					new SlashCommandOptionBuilder()
						.setName("Auto-Role")
						.setDescription("Which role should be automatically added, on join?")
						.setType(SlashCommandOptionType.ROLE)
						.setRequired(true)
						.build()),
			new SlashCommandBuilder()
				.setName("counter")
				.setDescription("Config your server counter channel!")
				.addOption(
					new SlashCommandOptionBuilder()
						.setName("CounterChannel")
						.setDescription("Which role should be updated?")
						.setType(SlashCommandOptionType.CHANNEL)
						.setRequired(true)
						.build()),
			new SlashCommandBuilder()
				.setName("leaving-log")
				.setDescription("Set your current channel as server leaving-log channel!"),
			new SlashCommandBuilder()
				.setName("off")
			...
			new SlashCommandBuilder()
				...
				.addOption(
					new SlashCommandOptionBuilder().setName("SONG")
						.setType(SlashCommandOptionType.STRING)
			...
			new SlashCommandBuilder()
				...
				.addOption(
					new SlashCommandOptionBuilder().setName("NAME")
				...
				.addOption(
					new SlashCommandOptionBuilder()
						...
						.setType(SlashCommandOptionType.INTEGER)
						.addChoice("PC", 0)
						.addChoice("XBOX", 1).addChoice("PLAYSTATION", 2)
						.setRequired(true)
						.build())
				.addOption(
					new SlashCommandOptionBuilder()
			...
			new SlashCommandBuilder()
				.setName("r6-map")
				.setDescription("Get a random Rainbow Six map!").addOption(
					new SlashCommandOptionBuilder()
						.setName("MAP-POOL")
